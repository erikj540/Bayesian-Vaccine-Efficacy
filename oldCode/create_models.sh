...
python create_stan_model.py --beta0="normal(0,1)" --beta1="gamma(2,4)" --se="beta(4,2)" --sp="beta(4,2)" --savepath="/Users/erjo3868/Bayesian-Vaccine-Efficacy/data/exp3/model.pkl"
