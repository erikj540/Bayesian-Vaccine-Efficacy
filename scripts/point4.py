...
def validation_ve_study(prev, alpha, se, sp, vax_prop, N, n_sens, n_spec, model_path, name):
    ...
    name = name + f'_N{N}_prev{int(100*prev)}_alpha{int(100*alpha)}_se{int(se*100)}_sp{int(sp*100)}_nSpec{n_spec}_nSens{n_sens}_vaxProp{int(vax_prop*100)}_nSamples{N_SAMPLES}'
...
sps = [0.9]
vax_props = [0.5]
ns = [0, 50, 100, 200, 500, 1000, 2000, 10000]
name = 'point4'
